...
function createAboutSection() {
  ...
  listContainer.style.maxWidth = "12rem";

  const listContainerContainer = document.createElement("div");
  listContainerContainer.classList.add("list-container-container");
  listContainerContainer.appendChild(listContainer);
  listContainerContainer.style.display = "flex";
  listContainerContainer.style.justifyContent = "center";
...
`;
  ...
  aboutSection.appendChild(listContainerContainer);
